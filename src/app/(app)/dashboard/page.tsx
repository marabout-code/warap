...
> = {
  ...
  admin: {
    ...
    quickActions: [
      ...
      { href: "/categories", title: "Gérer les catégories", desc: "Ajoutez, renommez et réordonnez les catégories de service", icon: ICONS.categories, gradient: GRADIENTS.accent },
