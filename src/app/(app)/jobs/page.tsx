  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Annonces de recrutement</h1>
          <p className="mt-1 text-sm text-slate-500">
            Publiez et suivez vos annonces de personnel domestique au Cameroun.
          </p>
        </div>
      ...
      <div className="card-glass flex flex-col gap-4 rounded-2xl border-white/60 px-5 py-4 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Rechercher une annonce par poste, famille ou quartier..."
            value={search}
                ...
                <tr>
                  <td colSpan={6} className="td text-center py-14">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="mt-4 text-sm font-semibold text-slate-700">Aucune annonce trouvée</p>
